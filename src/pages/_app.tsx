  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta name="theme-color" content="#110b75" />

        <meta key="twitter:card" name="twitter:card" content="app" />
        <meta key="twitter:title" name="twitter:title" content="DexMatic App" />
        <meta key="twitter:url" name="twitter:url" content="https://app.dexmatic.finance" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Be a DeFi Chef with DexMatix. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.dexmatic.finance/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@dex_matic" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="DexMatic App" />
        <meta key="og:url" property="og:url" content="https://app.dexmatic.finance" />
        <meta key="og:image" property="og:image" content="https://app.dexmatic.finance/apple-touch-icon.png" />
        <meta
          key="og:description"
